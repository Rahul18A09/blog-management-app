  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black">
      <div className="bg-white p-8 sm:p-10 rounded-2xl w-[90%] max-w-[480px] relative">
        ...
        <h2 className="text-xl font-bold text-center mb-8 mt-2 text-black">Login to Your Account</h2>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            <label className="block text-[#fb7700] text-sm font-medium mb-2">Email</label>
            <input 
              type="email" 
              required
          ...
          <div>
            <label className="block text-[#fb7700] text-sm font-medium mb-2">Password</label>
            <input 
              type="password" 
              required
